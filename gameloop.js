...
var Gameloop = {
  ...
  */
  init(fun) {
    ...
    this.started = true;
    this.webAnimationFrame  = requestAnimationFrame(Gameloop.main.bind(this)); 
  },
  main(currentTimeMS) {
    /*
    ...
    */
    ...
    this.panic = false;
    this.webAnimationFrame = requestAnimationFrame(this.main.bind(this));
  }
};
